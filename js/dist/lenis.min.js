!function(t, e) {
    ...
    class Animate {
        ...
        fromTo(t, e, {lerp: i=.1, duration: o=1, easing: s=(t=>t), onStart: n, onUpdate: r}) {
    ...
    class Dimensions {
        constructor({wrapper: t, content: e, autoResize: i=!0, debounce: o=250}={}) {
            this.wrapper = t,
            this.content = e,
            i && (this.debouncedResize = function debounce(t, e) {
                let i;
                return function() {
                    let o = arguments
                      , s = this;
        ...
        function Lenis(t) {
            ...
            this.onVirtualScroll = function(t) {
                ...
                if (!o.ctrlKey) {
                    ...
                    if (P.options.syncTouch && s && "touchstart" === o.type && !P.isStopped && !P.isLocked)
                        P.reset();
                    else {
                        var r = 0 === e && 0 === i
                          , l = "vertical" === P.options.gestureOrientation && 0 === i || "horizontal" === P.options.gestureOrientation && 0 === e;
                        if (!r && !l) {
                            var h = o.composedPath();
                            if (!(h = h.slice(0, h.indexOf(P.rootElement))).find((function(t) {
                                var e, i, o, r, l;
                                ...
                                if (P.isStopped || P.isLocked)
                                    ...
                                    if (P.isSmooth = P.options.syncTouch && s || P.options.smoothWheel && n,
                                    !P.isSmooth)
                                        return P.isScrolling = !1,
                                        void P.animate.stop();
                                    o.preventDefault();
                                    var a = i;
                                    "both" === P.options.gestureOrientation ? a = Math.abs(i) > Math.abs(e) ? i : e : "horizontal" === P.options.gestureOrientation && (a = e);
                                    var c = s && P.options.syncTouch
                                      , p = s && "touchend" === o.type && Math.abs(a) > 5;
                                    p && (a = P.velocity * P.options.touchInertiaMultiplier),
                                    P.scrollTo(P.targetScroll + a, __assign({
                                        programmatic: !1
                                    }, c ? {
        ...
        Lenis.prototype.scrollTo = function(t, e) {
            ...
            if (!this.isStopped && !this.isLocked || S) {
                if (["top", "left", "start"].includes(t))
                    ...
                    var b = void 0;
                    if ("string" == typeof t ? b = document.querySelector(t) : (null == t ? void 0 : t.nodeType) && (b = t),
                    b) {
                ...
                if ("number" == typeof t) {
                    if (t += n,
                    t = Math.round(t),
                    this.options.infinite ? y && (this.targetScroll = this.animatedScroll = this.scroll) : t = clamp(0, t, this.limit),
                    l)
